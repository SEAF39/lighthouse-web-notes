...
const breedDetails = function(breed) {
  // return the description of the specified breed
  return catBreeds[breed];
};

// get the description for the 'Bombay' breed by calling the breedDetails function
const bombay = breedDetails('Bombay');

// log the description of the 'Bombay' breed to the console
console.log(bombay);
